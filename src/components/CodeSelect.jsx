...
/**
 * Generic searchable code-label dropdown.
 * Predefined options + ability to add custom options to localStorage.
 */
const CodeSelect = ({ value, onChange, options = [], storageKey, placeholder = 'Search or select...' }) => {
    ...
    const allOptions = [
        ...options,
        ...customOptions.map(c => ({ code: c, label: c })),
    ];
    ...
    const isQueryNew = storageKey && searchTerm.trim() &&
    ...
    const addCustomOption = () => {
        ...
        if (!newCode) return;
        const updated = [...customOptions, newCode];
                    ...
                    <div className="p-2 space-y-0.5">
                        ...
                        {isQueryNew && (
                            ...
                            >
                                ...
                                Add "{searchTerm.trim().toUpperCase()}" as new option
                            </button>
                        )}
                    </div>
                </div>
